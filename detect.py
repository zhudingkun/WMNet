...
if __name__ == '__main__':
    ...
    parser.add_argument('--source1', type=str, default='/home/aaa/datasets/DVTODdataset/ir1/images/test', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/home/aaa/datasets/DVTODdataset/vis1/images/test', help='source')  # file/folder, 0 for webcam
